...
function Footer() {
    return (
        <footer className=" text-white pt-12 pb-8 px-4 md:px-8">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row gap-8 md:gap-12 lg:gap-24">
                    <div className="md:w-1/3 flex justify-center md:justify-start">
                        <img
                            src="src/assets/cloudops_logo.png"
                            alt="Company Logo"
                    ...
                    <div className="md:w-2/3 grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <ul className="space-y-2">
                                ...
                                <li><a href="#" className="text-gray-300 hover:text-blue-400 transition-colors">Code of Conduct</a></li>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="mt-6">
                                <h4 className="text-sm font-semibold text-gray-400 mb-2">NEWSLETTER</h4>
